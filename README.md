...
<br /><br />
Now let's look at the p-values of the predictors. Below data shows that AtBat (Number of times at bat in the season), Walks (Number of walks in the season), and PutOuts (Number of putouts in the season) are statistically significant, meaning their influence to the salary is significant.
<p align="center">
